...
const Item = /*#__PURE__*/React__default["default"].forwardRef(({
  ...
  const leadingVisualId = ssr.useSSRSafeId();
  const trailingVisualId = ssr.useSSRSafeId();
  ...
  }, /*#__PURE__*/React__default["default"].createElement(Slots, null, slots => /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, slots.LeadingVisual, /*#__PURE__*/React__default["default"].createElement("span", {
...
const SubTree = ({
  ...
  const [isLoadingItemVisible, setIsLoadingItemVisible] = React__default["default"].useState(false);
  const {
    safeSetTimeout
  } = useSafeTimeout();
  ...
  React__default["default"].useEffect(() => {
    if (state === 'done') {
      ...
      const parentName = shared.getAccessibleName(parentItem);
      safeSetTimeout(() => {
  ...
  return /*#__PURE__*/React__default["default"].createElement("ul", {
    ...
    ,
    ref: ref
  }, isLoadingItemVisible ? /*#__PURE__*/React__default["default"].createElement(LoadingItem, {
    ref: loadingItemRef,
    count: count
  }) : children);
};
