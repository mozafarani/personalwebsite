...
function roundToSingleUnit(duration) {
  if (duration.blank)
    return duration;
...
var RelativeTimeElement = class extends HTMLElement {
  ...
  get month() {
    ...
    const month = (_a = this.getAttribute("month")) !== null && _a !== void 0 ? _a : defaultFormatStyle;
...
_RelativeTimeElement_customTitle = /* @__PURE__ */ new WeakMap(), _RelativeTimeElement_updating = /* @__PURE__ */ new WeakMap(), _RelativeTimeElement_renderRoot = /* @__PURE__ */ new WeakMap(), _RelativeTimeElement_instances = /* @__PURE__ */ new WeakSet(), _RelativeTimeElement_lang_get = /* @__PURE__ */ __name(function _RelativeTimeElement_lang_get2() {
  ...
  const relativeFormat = new Intl.RelativeTimeFormat(__classPrivateFieldGet2(this, _RelativeTimeElement_instances, "a", _RelativeTimeElement_lang_get), { numeric: "auto", style: this.formatStyle });
  const tense = this.tense;
...
try {
  ...
  root2.RelativeTimeElement = RelativeTimeElement;
} catch (e) {
